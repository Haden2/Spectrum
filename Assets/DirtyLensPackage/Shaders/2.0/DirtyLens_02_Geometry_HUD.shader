...
Shader "DirtyLens/2.0/DirtyLens_02_Geometry_HUD" {
    Properties {
        _Flare ("Flare", 2D) = "white" {}
        _FlareTint ("FlareTint", Color) = (1,1,1,1)
...
////// Emissive:
                ...
                float3 node_83 = pow((_FlareTint.rgb*(_FlareMultiplier*tex2D(_Flare,TRANSFORM_TEX(node_38.rg, _Flare)).rgb)),_FlarePower);
